        ...
        <Box sx={{ width: '100%' }}>
            <ValidatorForm ref={form} onSubmit={handleSubmit}>
                <Box style={{ display: 'block', width: '100%', marginBottom: 5 }}>
                    ...
                    <Box sx={{ float: "left", minWidth: "45%", margin: 2, boxShadow, borderRadius }}>
                        <RenderFormContols shadow={true} location="managersupervisor" mode={props.mode} title={"Manager"}
                            controls={props.controls.managersupervisor} options={props.options} onInputChange={OnInputChange} />
                    </Box>
                </Box>
            </ValidatorForm>
        </Box>
